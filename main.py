...
def send_likes(uid):
    try:
        res = requests.get(
            f"https://sumon-like-pro.vercel.app/like?uid=3532354697&server_name=bd",
            timeout=15
        )
        ...
        if res.status_code != 200:
            return f"""
[C][B][FF0000]━━━━━
[FFFFFF]Like API NAI TOMRA NITE CHAILE 8+LEVER ER GUEST ID DAW!
...
[C][B][11EAFD]━━━━━━━━━━━━
[C][B][FF00FF]Owner: [FFFFFF] SUMON 9X [00FF00]!!
"""
